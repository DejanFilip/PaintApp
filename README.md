...
каде што на истиот ги има сите важни копчиња(<b>buttons</b>) на кои се имплементирани функционалностите за да работи програмата. За бирање на боја има две копчиња:<br>
...
Копчињата за цртање се состојат од:
...
<b>Clear</b> за бришење на се што ќе се нацрта, <b>Save</b> за зачувување,додека <b>Open</b> за отварање на зачуваното од соодветниот фолдер на компјутерот. 
<li>Во долниот десен агол имаме лабела со координатите при движење на маусот на pictureBox-ot. 
</ul>

<h2>Опис на решавање на проблемот</h2>
1. <b>MouseMoveDown</b>, <b>MouseMoveUp</b> и <b>MouseMove</b> методите

Прво го имаме event-от <b>MouseDown</b> кој регистрира дека сме почнале со цртање и ја зема локацијата на нашиот курсор во дадениот момент и X и Y оските.
Потоа со event-от  <b>MouseUp</b>  со помош на нашиот flag кажуваме дека сме завршиле со цртање, односно нашиот маус не го држиме кликнат повеќе и во зависност од индексот се исцртува конкретната форма која може да биде елипса, правоаголник, права линија и триаголник. 
...
Во овој метод соодветни исцртувања се, пенкалото за слободно цртање и гумата и <b>Refresh()</b> методата која е слична на <b>Invalidate()</b> ја повикуваме директно на платното кое цртаме. 
...
-Save ни овозможува зачувување на нашиот цртеж во локалната машина на која цртаме и ги зачувува фајловите во jpg формат.
...
При исцртување на формата според индексот, овој метод ни овозможува пред да го отпуштиме левиот клик на маусот да видиме колкава е големината на формата и откако ќе
отпуштиме тогаш се исцртува.
Тоа го извршуваме со Graphics g варијаблата која ја повикуваме за исцртување на секоја форма.
...
![image](https://user-images.githubusercontent.com/100298572/176914795-109ae3ad-075f-4e1f-b0b5-2992ad14667b.png)
...
Ни овозможува на промена на вредноста на <b>numericUpAndDown</b> да ја менуваме ширината на пенкалото и сите останати форми.
