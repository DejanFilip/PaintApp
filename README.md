...
Прво го имаме event-от __MouseDown__ кој регистрира дека сме почнале со цртанје и ја зема локацијата на напиот курсор во дадениот момент и X и Y оските.
Потоа со event-от  **MouseUp**  со помош на нашиот flag кажуваме дека сме завршиле со цртанје односно нашиот маус не го држиме кликнат повеќе и во зависност од индексот
се исцртува конкретната форма која може да биде елипса, правоаголник
И event-от **MouseMove** кој цело време ја подесува локацијата на нашиот курсор и во десниот долен агол ни ја покажува точната локација според X и Y оските.
