...
Во овој метод соодветни исртувања се , пенкалото за слободно цртање и гумата i <b>Refresh()</b> методата која е слична на <b>Invalidate()</b> ја повикуваме директно на платното кое цртаме. 
